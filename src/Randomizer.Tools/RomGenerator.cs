...
{
    private const string SmRomPath = @"E:\SMZ3\Super Metroid (Japan, USA) (En,Ja).sfc";
    private const string Z3RomPath = @"E:\SMZ3\Zelda no Densetsu - Kamigami no Triforce (Japan).sfc";
    private const string IpsPath = @"D:\Source\SMZ3Randomizer\alttp_sm_combo_randomizer_rom\build\zsm.ips";
    private const string OutputPath = @"E:\SMZ3\TestRom";
    ...
    public static string GenerateRom(bool openRom)
    {

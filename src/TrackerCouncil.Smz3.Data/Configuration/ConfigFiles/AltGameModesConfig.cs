...
public class AltGameModesConfig : IMergeable<AltGameModesConfig>, IConfigFile<AltGameModesConfig>
{
    public static AltGameModesConfig Default()
    {
        return new AltGameModesConfig();
    }

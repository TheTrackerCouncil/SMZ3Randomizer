    ...
    class LegacyWest : LegacySMRegion {
        ...
        public LegacyWest(LegacyWorld legacyWorld, LegacyConfig legacyConfig) : base(legacyWorld, legacyConfig) {
            Locations = new List<LegacyLocation> {
                new LegacyLocation(this, 70, 0x8F8E6E, LocationType.Visible, "Missile (Gold Torizo)", Logic switch {
                ...
                new LegacyLocation(this, 71, 0x8F8E74, LocationType.Hidden, "Super Missile (Gold Torizo)", Logic switch {
                ...
                new LegacyLocation(this, 79, 0x8F9110, LocationType.Chozo, "Screw Attack", Logic switch {
                ...
                new LegacyLocation(this, 73, 0x8F8F30, LocationType.Visible, "Missile (Mickey Mouse room)", Logic switch {
        ...
        public override bool CanEnter(LegacyProgression items) {
            return Logic switch {
                ...
                _ =>
                    LegacyWorld.CanEnter("Norfair Upper East", items) && items.CanUsePowerBombs() && items.Varia && (items.HiJump || items.Gravity) && (
                        /* Trivial case, Bubble Mountain access */
                        items.CardNorfairL2 ||
                        /* Frog Speedway -> UN Farming Room gate */

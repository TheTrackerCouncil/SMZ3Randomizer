    ...
    public class Tracker : IDisposable
    {
        ...
        public void ClearArea(IHasLocations area, bool trackItems, bool includeUnavailable = false, float? confidence = null, bool assumeKeys = false)
        {
            ...
            else
            {
                ...
                if (onlyLocation != null)
                {
                    ...
                    {
                        var item = ItemService.Get(onlyLocation);
                        if (item == null)
                        {
                ...
                else
                {
                    ...
                    if (trackItems)
                    {
                        ...
                        {
                            var someOutOfLogicItem = ItemService.Get(someOutOfLogicLocation);
        ...
        public void MarkDungeonAsIncomplete(DungeonInfo dungeon, float? confidence = null)
        {
            ...
            if (dungeon.LocationId != null)
            {
                ...
                {
                    var item = ItemService.Get(rewardLocation);
                    if (item != null && item.TrackingState > 0)
                    {
                        UntrackItem(item);
        ...
        {
            var sahasrahlaItem = ItemService.Get(World.LightWorldNorthEast.SahasrahlasHideout.Sahasrahla);
            ...
            var pedItem = ItemService.Get(World.LightWorldNorthWest.MasterSwordPedestal);
        ...
        protected internal bool IsWorth(ItemData item)
        {
            ...
            if (leads.TryGetValue(item.InternalItemType, out var leadsToLocation))
            {
                ...
                {
                    var reward = ItemService.Get(location);
                    if (reward != null)
                    {

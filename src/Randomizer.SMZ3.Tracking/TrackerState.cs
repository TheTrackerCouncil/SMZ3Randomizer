    ...
    public class TrackerState
    {
        ...
        public static TrackerState TakeSnapshot(Tracker tracker)
        {
            ...
            var regionStates = tracker.World.Regions
                ...
                .ToImmutableList();
            var dungeonStates = tracker.Locations.Dungeons
        ...
        public void Apply(Tracker tracker)
        {
            ...
            {
                var dungeon = tracker.Locations.Dungeons.SingleOrDefault(x => x.Name.Contains(dungeonState.Name, StringComparison.OrdinalIgnoreCase))

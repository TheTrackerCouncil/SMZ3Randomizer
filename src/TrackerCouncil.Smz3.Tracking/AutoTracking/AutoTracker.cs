...
public class AutoTracker : AutoTrackerBase
{
    ...
    {
        if (_foundGTKey || _config.Config is { ZeldaKeysanity: true, GameModeOptions.KeysanityGanonsTowerBigKeyLocation: KeysanityGanonsTowerBigKeyLocation.Anywhere }) return;

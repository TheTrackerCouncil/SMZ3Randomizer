    ...
    public class IcePalace : Z3Region, IHasReward
    {
        ...
        public IcePalace(World world, Config config) : base(world, config)
        {
            ...
            MapChest = new Location(this, 256 + 163, 0x1E9DD, LocationType.Regular,
                ...
                access: items => items.Hammer && World.AdvancedLogic.CanLiftLight(items) && (
            ...
            KholdstareReward = new Location(this, 256 + 168, 0x308157, LocationType.Regular,
                ...
                access: items => items.BigKeyIP && items.Hammer && World.AdvancedLogic.CanLiftLight(items) &&
        ...
        {
            return items.MoonPearl && items.Flippers && World.AdvancedLogic.CanLiftHeavy(items) && World.AdvancedLogic.CanMeltFreezors(items);
        }

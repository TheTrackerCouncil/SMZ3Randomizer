...
namespace Randomizer.Shared
{
    public class LogicConfig
    {
        ...
        [DisplayName("Left Sand Pit Requires Spring Ball"), Description("You're expected to have the spring ball to navigate the left sand pit in Maridia."), Category("Logic")]

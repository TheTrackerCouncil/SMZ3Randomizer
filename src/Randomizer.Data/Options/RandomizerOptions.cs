        ...
        public Config ToConfig()
        {
            if (string.IsNullOrWhiteSpace(SeedOptions.ConfigString)) {
                var config = new Config()
                {
                    ...
                    LinkName = PatchOptions.SelectedLinkSprite == Sprite.DefaultLink ? "Link" : PatchOptions.SelectedLinkSprite.Name,
                    SamusName = PatchOptions.SelectedSamusSprite == Sprite.DefaultSamus ? "Samus" : PatchOptions.SelectedSamusSprite.Name,

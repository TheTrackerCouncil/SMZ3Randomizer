...
namespace Randomizer.Data.WorldData.Regions.SuperMetroid.Crateria
{
    public class EastCrateria : SMRegion
    {
        ...
        public class WestOceanRoom : Room
        {
            ...
            {
                FloodedCavernUnderWater = new Location(this, LocationId.WestOceanFloodedCavern, 0x8F81E8, LocationType.Visible,
                ...
                SkyMissile = new Location(this, LocationId.WestOceanSky, 0x8F81EE, LocationType.Hidden,
                    ...
                    metadata: metadata,
                    trackerState: trackerState);
                MorphBallMaze = new Location(this, LocationId.WestOceanMorphBallMaze, 0x8F81F4, LocationType.Visible,
        ...
        public class TheMoatRoom : Room
        {
            ...
            {
                Moat = new Location(this, LocationId.TheMoat, 0x8F8248, LocationType.Visible,

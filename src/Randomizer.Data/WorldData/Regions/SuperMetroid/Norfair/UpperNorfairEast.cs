    ...
    public class UpperNorfairEast : SMRegion
    {
        ...
        public class BubbleMountainHiddenHallRoom : Room
        {
                ...
                : base(region, "Bubble Mountain Hidden Hall", metadata, "Norfair Reserve Tank")
            {
                ...
                HiddenItem = new Location(this, LocationId.NorfairReserveTankHidden, 0x8F8C44, LocationType.Hidden,
                    name: "Hidden Item",
        ...
        public class GreenBubblesMissileRoom : Room
        {
            ...
            {
                BubbleMountainMissileRoom = new Location(this, LocationId.GreenBubblesMissile, 0x8F8C52, LocationType.Visible,
        ...
        public class BubbleMountainRoom : Room
        {
            ...
            {
                BubbleMountain = new Location(this, LocationId.BubbleMountain, 0x8F8C66, LocationType.Visible,
        ...
        public class SpeedBoosterHallRoom : Room
        {
            ...
            {
                SpeedBoosterHallCeiling = new Location(this, LocationId.SpeedBoosterHall, 0x8F8C74, LocationType.Hidden,
        ...
        public class SpeedBoosterRoom : Room
        {
            ...
            {
                SpeedBooster = new Location(this, LocationId.SpeedBooster, 0x8F8C82, LocationType.Chozo,
                    name: "Speed Booster",
        ...
        public class DoubleChamberRoom : Room
        {
            ...
            {
                DoubleChamber = new Location(this, LocationId.DoubleChamber, 0x8F8CBC, LocationType.Visible,
        ...
        public class WaveBeamRoom : Room
        {
            ...
            {
                WaveBeam = new Location(this, LocationId.WaveBeam, 0x8F8CCA, LocationType.Chozo,
                    name: "Wave Beam",

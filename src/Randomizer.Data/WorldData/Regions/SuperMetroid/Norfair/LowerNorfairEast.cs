...
namespace Randomizer.Data.WorldData.Regions.SuperMetroid.Norfair
{
    public class LowerNorfairEast : SMRegion, IHasBoss
    {
        ...
        public class SpringBallMazeRoom : Room
        {
            ...
            {
                SpringBallMaze = new Location(this, LocationId.SpringBallMaze, 0x8F8FCA, LocationType.Visible,
        ...
        public class EscapePowerBombRoom : Room
        {
            ...
            {
                PowerBomb = new Location(this, LocationId.EscapePowerBomb, 0x8F8FD2, LocationType.Visible,
        ...
        public class WastelandRoom : Room
        {
            ...
            {
                PowerBombOfShame = new Location(this, LocationId.Wasteland, 0x8F90C0, LocationType.Visible,
        ...
        public class ThreeMusketeersRoom : Room
        {
            ...
            {
                Missile = new Location(this, LocationId.ThreeMusketeers, 0x8F9100, LocationType.Visible,
        ...
        public class RidleyTankRoom : Room
        {
           ...
           {
                RidleyTreasure = new Location(this, LocationId.RidleyTank, 0x8F9108, LocationType.Hidden,

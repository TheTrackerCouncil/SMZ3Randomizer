        ...
        public PalaceOfDarkness(World world, Config config, IMetadataService? metadata, TrackerState? trackerState) : base(world, config, metadata, trackerState)
        {
            ...
            BigKeyChest = new Location(this, LocationId.PalaceOfDarknessBigKeyChest, 0x1EA37, LocationType.Regular,
                ...
                access: items => BigKeyChest != null && items.KeyPD >= (BigKeyChest.ItemIs(ItemType.KeyPD, World) ? 1 :
                    (items.Hammer && items.Bow && Logic.CanPassSwordOnlyDarkRooms(items)) || config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 6 : 5),
                memoryAddress: 0x3A,
                memoryFlag: 0x4,
                metadata: metadata,
                trackerState: trackerState)
            ...
            CompassChest = new Location(this, LocationId.PalaceOfDarknessCompassChest, 0x1EA43, LocationType.Regular,
                ...
                access: items => items.KeyPD >= ((items.Hammer && items.Bow && Logic.CanPassSwordOnlyDarkRooms(items)) || config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 4 : 3),
                memoryAddress: 0x1A,
                memoryFlag: 0x5,
                metadata: metadata,
                trackerState: trackerState);
            ...
            HarmlessHellway = new Location(this, LocationId.PalaceOfDarknessHarmlessHellway, 0x1EA46, LocationType.Regular,
                ...
                access: items => HarmlessHellway != null && items.KeyPD >= (HarmlessHellway.ItemIs(ItemType.KeyPD, World) ?
                    (items.Hammer && items.Bow && Logic.CanPassSwordOnlyDarkRooms(items)) || config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 4 : 3 :
                    (items.Hammer && items.Bow && Logic.CanPassSwordOnlyDarkRooms(items)) || config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 6 : 5),
                memoryAddress: 0x1A,
                memoryFlag: 0x6,
                metadata: metadata,
            ...
            BigChest = new Location(this, LocationId.PalaceOfDarknessBigChest, 0x1EA40, LocationType.Regular,
                ...
                access: items => items.BigKeyPD && Logic.CanPassSwordOnlyDarkRooms(items) && items.KeyPD >= ((items.Hammer && items.Bow) || config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 6 : 5),
                memoryAddress: 0x1A,
                memoryFlag: 0x4,
                metadata: metadata,
                trackerState: trackerState);
                ...
                : base(region, "Dark Maze", metadata)
            {
                Locations = new List<Location>
                {
                    new Location(this, LocationId.PalaceOfDarknessDarkMazeTop, 0x1EA55, LocationType.Regular,
                        ...
                        access: items => Logic.CanPassSwordOnlyDarkRooms(items) && items.KeyPD >= ((items.Hammer && items.Bow) || Config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 6 : 5),
                        memoryAddress: 0x19,
                        memoryFlag: 0x4,
                        metadata: metadata,
                        trackerState: trackerState),
                ...
                : base(region, "Dark Basement", metadata)
            {
                Locations = new List<Location>
                {
                    new Location(this, LocationId.PalaceOfDarknessDarkBasementLeft, 0x1EA4C, LocationType.Regular,
                        ...
                        access: items => Logic.CanPassFireRodDarkRooms(items) && items.KeyPD >= ((items.Hammer && items.Bow) || Config.GameModeConfigs.KeysanityConfig.ZeldaKeysanity ? 4 : 3),
                        memoryAddress: 0x6A,
                        memoryFlag: 0x4,
                        metadata: metadata,
                        trackerState: trackerState),

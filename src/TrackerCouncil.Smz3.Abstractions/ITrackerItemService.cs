...
public interface ITrackerItemService
{
    ...
    void TrackItemAmount(Item item, int count, float confidence, bool force = false, bool silent = false);
    ...
    void UntrackItem(Item item, float? confidence = null, bool force = false, bool silent = false);

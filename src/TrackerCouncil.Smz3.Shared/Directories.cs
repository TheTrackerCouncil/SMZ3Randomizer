...
#else
    public static string SpriteHashYamlFilePath => Path.Combine(DataPath "sprite-hashes.yml");
#endif
...
#else
    public static string TrackerSpriteHashYamlFilePath => Path.Combine(DataPath, "tracker-sprite-hashes.yml");
#endif

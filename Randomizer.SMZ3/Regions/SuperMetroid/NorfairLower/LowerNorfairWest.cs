...
namespace Randomizer.SMZ3.Regions.SuperMetroid.NorfairLower
{
    public class LowerNorfairWest : SMRegion
    {
        ...
        public Location BeforeGoldTorizo => new(this, 70, 0x8F8E6E, LocationType.Visible,
        ...
        public Location GoldTorizoCeiling => new(this, 71, 0x8F8E74, LocationType.Hidden,
        ...
        public Location ScrewAttackRoom => new(this, 79, 0x8F9110, LocationType.Chozo,
            name: "Screw Attack",
            access: Logic switch
            {
        ...
        public Location MickeyMouseRoom => new(this, 73, 0x8F8F30, LocationType.Visible,

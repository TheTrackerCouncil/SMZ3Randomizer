        ...
        public LightWorldSouth(World world, Config config) : base(world, config)
        {
            ...
            Locations = new List<Location> {
                ...
                new Location(this, 256+242, 0x308003, LocationType.Regular, "South of Grove",
                    items => items.Mirror && World.DarkWorldSouth.CanEnter(items)),
                ...
                new Location(this, 256+252, 0x308143, LocationType.Regular, "Desert Ledge",
                    items => World.DesertPalace.CanEnter(items)),
                ...
                new Location(this, 256+58, 0x308017, LocationType.Bombos, "Bombos Tablet",
                    items => items.Book && items.MasterSword && items.Mirror && World.DarkWorldSouth.CanEnter(items)),

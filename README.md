...
found on the [GitHub releases] page. You can also find information about limited cross-platform version that supports Linux [here](https://github.com/Vivelin/SMZ3Randomizer/tree/main/src/TrackerCouncil/Smz3/UI/README.md).
